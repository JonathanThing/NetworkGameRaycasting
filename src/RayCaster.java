...
public class RayCaster {
    ...
    private final int numberOfRays = 360;
    private final double[] dist = new double[numberOfRays];
    ...
    public void drawSprite(Graphics2D g2, ArrayList<Entity> entities) {
        ...
        entities.sort(new DistanceComparator());
        ...
        for (int rays = 0; rays < numberOfRays; rays++) {
            ...
            if (drawingMap) {
                ...
                for (int i = 0; i < numbPixel; i++) {
                    ...
                    int valueRGB = texture.getRGB(textureX, textureY);
